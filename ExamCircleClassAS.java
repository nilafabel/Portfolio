...
public class ExamCircleClassAS {
    ...
    public ExamCircleClassAS(double radius) {//Constructor. Accepts the radius of the circle as an argument.
        this.radius = radius;
    }
    public ExamCircleClassAS() {//Constructor. A no-arg constructor that sets the radius field to 0.0.
        radius = 0.0;
    }
